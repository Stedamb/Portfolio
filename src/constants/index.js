...
const experiences = [
    {
        ...
        points: [
            "Developing and maintaining web applications using React.js and other related tec" +
                    "hnologies.",
            "Collaborating with cross-functional teams including designers, product managers," +
                    " and other developers to create high-quality products.",
            "Implementing responsive design and ensuring cross-browser compatibility.",
            "Participating in code reviews and providing constructive feedback to other devel" +
                    "opers."
        ]
    }, {
...
const testimonials = [
    {
        testimonial: "I thought it was impossible to make a website as beautiful as our product, but R" +
                "ick proved me wrong.",
        name: "Sara Lee",
        designation: "CFO",
        company: "Acme Co",
        ...
        testimonial: "I've never met a web developer who truly cares about their clients' success like" +
                " Rick does.",
        name: "Chris Brown",
        designation: "COO",
        company: "DEF Corp",
        ...
        testimonial: "After Rick optimized our website, our traffic increased by 50%. We can't thank t" +
                "hem enough!",
        name: "Lisa Wang",
        designation: "CTO",
